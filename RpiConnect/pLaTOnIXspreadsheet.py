...
base_path = "DummyDatabase.ods"
sheet = "Sheet1"

df = read_ods(base_path,sheet,columns=["PlateN","Make","Model","Color","RegStat","AgencyLoc"])
df.set_index('PlateN', inplace = True)
...
try:
    ...
    try:
        ...
        while os.path.exists("plates/processed/Unregistered/" + plateFilename + str(b) + ".jpg"):
            ...
            print('The Plate Number ' + res + ' is Unregistered in the Database.')
            exit()
else:
    print("Number plate is:", plate)
    print(df.loc[[(str(res))]])
